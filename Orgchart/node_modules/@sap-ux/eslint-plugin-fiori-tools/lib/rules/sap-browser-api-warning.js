...
const rule = {
    ...
    create(context) {
        ...
        function isCondition(node) {
            return (0, helpers_1.isType)(node, IF_CONDITION) || (0, helpers_1.isType)(node, CONDITION_EXP);
        }
        /**
        ...
        function isUnary(node) {
            return (0, helpers_1.isType)(node, UNARY);
        }
        /**
        ...
        function isHistory(node, justHistory) {
            if (node && (0, helpers_1.isIdentifier)(node) && 'name' in node) {
                return node.name === 'history' || (!justHistory && FORBIDDEN_HISTORY_OBJECT.includes(node.name));
            }
            else if (node && (0, helpers_1.isMember)(node)) {
        ...
        function isMinusOne(node) {
            return (isUnary(node) &&
                node.operator === '-' &&
                (0, helpers_1.isLiteral)(node.argument) &&
        ...
        function processHistory(node) {
            ...
            if (isHistory(callee.object, false) && (0, helpers_1.isIdentifier)(callee.property) && 'name' in callee.property) {
        ...
        function handleForbiddenMethodCall(node, methodName) {
            const calleePath = (0, helpers_1.buildCalleePath)(node);
        ...
        function handleNonCallExpressionMember(node) {
            const calleePathNonCmpt = (0, helpers_1.buildCalleePath)(node);
            const speciousObjectNonCmpt = (0, helpers_1.isForbiddenObviousApi)(calleePathNonCmpt);
        ...
        return {
            ...
            'MemberExpression': function (node) {
                if ((0, helpers_1.isCall)(node.parent) && !node.computed) {
