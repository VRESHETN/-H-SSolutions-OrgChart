...
class CDSWriter {
    ...
    [change_1.MOVE_COLLECTION_VALUE_CHANGE_TYPE] = (change, reversePath) => {
        ...
        if (anchor) {
            ...
            }, anchor.position, ranges, indentLevel);
...
function getTextEditsForMove(writerContext, position, ranges, indentLevel) {
    const edits = [];
    const text = [];
...
function cutRange(writerContext, content, cutRange, indentLevel, text, edits) {
