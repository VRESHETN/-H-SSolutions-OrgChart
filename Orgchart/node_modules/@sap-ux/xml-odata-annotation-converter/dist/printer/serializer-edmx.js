    ...
    const schemaSnippet = (0, odata_annotation_core_1.createElementNode)({
        ...
        content: [
            (0, odata_annotation_core_1.createTextNode)('\n' +
                (odata_annotation_core_1.printOptions.useTabs ? (0, odata_annotation_core_1.indentWithTabs)(3) : (0, odata_annotation_core_1.indentWithSpaces)(odata_annotation_core_1.printOptions.tabWidth, 3)) +
                'INSERT_TOKEN' +
                '\n' +
                (odata_annotation_core_1.printOptions.useTabs ? (0, odata_annotation_core_1.indentWithTabs)(2) : (0, odata_annotation_core_1.indentWithSpaces)(odata_annotation_core_1.printOptions.tabWidth, 2)))
        ]
    });
